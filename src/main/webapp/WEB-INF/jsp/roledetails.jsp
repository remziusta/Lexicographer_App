...
<body>
	...
	<section id="actions" class="py-4 mb-4 bg-light">
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<a href="/roles" class="btn btn-primary btn-block"> <i
						...
						<div class="card-header">
							...
							<div class="card-body">
								<form:form modelAttribute="role" method="post"
									action="/roles/role/update/${role.getId()}"
									cssClass="form-inline">
									<div class="form-group">
										<b>Role Name :</b>
										<form:input path="ROLE" value="${role.getROLE()}"
									...
									<div class="form-group">
										<a class="btn btn-danger ml-3"
											href="/roles/role/delete/${role.getId()}"><i
