		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav">
					...
					<li class="nav-item px-2"><a href="/types"
	...
	<header id="main-header" class="py-2 bg-warning text-white">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<h1>
						<i class="fas fa-pencil-alt"></i> Word Types
					</h1>
				</div>
			</div>
		</div>
				...
				<div class="col">
					...
					<form:form modelAttribute="type" method="post"
						...
						<div class="form-group">
							<b>Type Name :</b>
							<form:input path="TYPE" cssClass="form-control ml-3" />
						</div>
						<div class="form-group">
							<button class="btn btn-warning ml-3" type="submit">Save</button>
							...
							<tbody>
								<c:forEach items="${types}" var="type" varStatus="status">
									<tr>
										<td>${type.getId()}</td>
										<td>${type.getTYPE()}</td>
										<td><a href="/types/type/details/${type.getId()}"
