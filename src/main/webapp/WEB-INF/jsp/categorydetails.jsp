...
<body>
	...
	<section id="actions" class="py-4 mb-4 bg-light">
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<a href="/categories" class="btn btn-primary btn-block"> <i
						...
						<div class="card-header">
							<div class="card-body">
								<form:form modelAttribute="category" method="post"
									action="/categories/category/update/${category.getId()}"
									cssClass="form-inline">
									<div class="form-group">
										<b>Category Name :</b>
										<form:input path="CATEGORY" value="${category.getCATEGORY()}"
									...
									<div class="form-group">
										<a class="btn btn-danger ml-3"
											href="/categories/category/delete/${category.getId()}"><i
